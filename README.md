...
Diese Webanwendung zeigt alle Pokémon der **Generationen 1 bis 9**
(Nationaldex #001–#1025) als Karten mit ihren Eigenschaften (Name, Bild, Typ,
etc.).
...
3. Im Suchfeld **mindestens 3 Zeichen** (Name) **oder Ziffern** (ID) eingeben,
   um zu filtern
